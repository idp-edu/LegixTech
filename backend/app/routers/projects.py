...
async def listar_projetos(
    ...
    por_pagina: int = Query(50, ge=1, le=100),  # ← CORRIGIDO: era 20
    db: Session = Depends(get_db),
):
    limit_busca = por_pagina * 10 if ods is not None else por_pagina  # ← CORRIGIDO: era * 5
    ...
    # ← CORRIGIDO: só usa banco local se tiver registros suficientes (≥ 20).
    ...
    # Fallback: busca direto na API da Câmara garantindo mínimo de 50 itens
