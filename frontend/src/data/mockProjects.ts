...
// 🚀 CORRIGIDO: Tipagem estendida inline garante compatibilidade total com o TypeScript
export const mockProjects: Array<UiProject & {
  trending?: boolean;
  impact?: string[];
  affected?: string[];
  introduced?: string;
  ...
  { 
    ...
    trending: true, 
    category: 'Saúde', 
    summary: 'Este projeto visa expandir a cobertura de saúde para comunidades carentes, fornecendo subsídios para famílias de baixa renda e estabelecendo novos centros de saúde comunitários em áreas rurais.', 
  ...
  { 
    ...
    summary: 'Legislação para acelerar a transição para energia renovável, fornecendo créditos fiscais para empresas de energia limpa e financiando programas de capacitação profissional.', 
    ...
    impact: [ 
      ...
      'Estabelece programs de capacitação em empregos verdes em 25 estados', 
    ], 
  ...
  { 
    ...
    trending: true, 
    category: 'Tecnologia', 
    summary: 'Legislação abrangente de privacidade de dados que exige que empresas obtenham consentimento explícito antes de coletar dados pessoais e estabelece penalidades para vazamentos de dados.', 
  ...
  { 
    ...
    status: 'approved', 
    category: 'Educação', 
    summary: 'Aumenta o financiamento federal para educação básica com foco em programas STEM, salários de professores e melhorias na infraestrutura escolar.', 
  ...
  { 
    ...
    status: 'active', 
    category: 'Economia', 
    summary: 'Fornece assistência financeira e alívio fiscal para pequenas empresas afetadas por desafios econômicos, incluindo subsídios e empréstimos com juros baixos.', 
  ...
  { 
    ...
    status: 'archived', 
    category: 'Habitação', 
    summary: 'Legislação para aumentar a oferta de moradia acessível através de incentivos para construtoras e financiamento para projetos de habitação pública.', 
