...
interface SavedProjectsProps {
  ...
  onRemovePolitician: (id: string) => void | Promise<void>; // ← aceita async
...
export function SavedProjects({
  ...
  // politicians já vem filtrado do saved.tsx — sem filtro local
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      <View style={{
        ...
        <TabButton id="politicos" label={`Seguindo (${politiciansList.length})`} />
      </View>
            ...
            <View style={{ alignItems: 'center', paddingVertical: 64 }}>
              ...
              {onNavigateToSearch && (
                <Pressable
                  ...
                  style={{
                    minHeight: 44, borderRadius: 8, backgroundColor: colors.primary,
            ...
            politiciansList.map((politician) => (
              <View key={politician.id} style={{
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 16 }}>
                  ...
                  <Pressable
                    onPress={() => void onRemovePolitician(politician.id)} // ← void para tratar async
                    style={{
